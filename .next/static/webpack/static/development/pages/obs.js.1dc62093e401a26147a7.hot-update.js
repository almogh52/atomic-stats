...
function (_BasePage) {
  ...
  function ObsOverlay(props) {
    ...
    _this.newStats = _this.props.startStats;
  ...
  _createClass(ObsOverlay, [{
    ...
    value: function componentDidMount() {
      var intervalId = setInterval(this.updateStats, 1000); // store intervalId in the state so it can be accessed later:
...
//# sourceMappingURL=obs.js.1dc62093e401a26147a7.hot-update.js.map