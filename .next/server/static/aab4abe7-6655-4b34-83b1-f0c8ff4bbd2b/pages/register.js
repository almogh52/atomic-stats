...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(0);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_atomic_card__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(15);
/* harmony import */ var rmwc_Button__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4);
/* harmony import */ var rmwc_Button__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(rmwc_Button__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var rmwc_TextField__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(9);
/* harmony import */ var rmwc_TextField__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(rmwc_TextField__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony import */ var react_recaptcha__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(29);
...
/* harmony import */ var _styles_register_scss__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(48);
/* harmony import */ var _styles_register_scss__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_styles_register_scss__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _components_base_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(12);
...
function (_BasePage) {
  ...
  function Register(props) {
    ...
    _this.state = {
      username: _this.props.username ? _this.props.username : "",
      email: _this.props.email ? _this.props.email : "",
      password: "",
      passwordConfirm: ""
    };
    _this.checkPassword = _this.checkPassword.bind(_assertThisInitialized(_this));
    _this.colorForPassword = _this.colorForPassword.bind(_assertThisInitialized(_this));
  ...
  _createClass(Register, [{
    ...
    key: "colorForPassword",
    value: function colorForPassword() {
    ...
    value: function validateForm(event) {
      if (event.target.username.value == "" || event.target.email.value == "" || event.target.password.value == "" || event.target.passwordConfirm.value == "" || !this.validateEmail() || !this.validateUsername() || this.checkPassword() == "Week password" || this.state.password != this.state.passwordConfirm) event.preventDefault();
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_atomic_card__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"], {
        className: "atomic-register",
        title: "Register",
        titleSize: "headline3",
      ...
      }, this.props.errorMessage), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("form", {
        action: "/register",
        method: "POST",
      ...
      }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(rmwc_TextField__WEBPACK_IMPORTED_MODULE_4__["TextField"], {
        box: true,
        required: true,
        className: "atomic-register-text-field atomic-text-field",
        style: {
          width: "350px"
        },
        ...
        name: "username",
        type: "text"
      }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(rmwc_TextField__WEBPACK_IMPORTED_MODULE_4__["TextFieldHelperText"], {
        persistent: true,
        style: {
          alignSelf: "start",
          color: this.validateUsername() ? "#2196f3" : "#f44336",
          fontSize: "13px"
        }
      }, this.state.username ? this.validateUsername() ? "" : "Invalid username" : ""), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(rmwc_TextField__WEBPACK_IMPORTED_MODULE_4__["TextField"], {
        box: true,
        required: true,
        className: "atomic-register-text-field atomic-text-field",
        style: {
        ...
        style: {
          alignSelf: "start",
          color: this.validateEmail() ? "#2196f3" : "#f44336",
          fontSize: "13px"
        }
      }, this.state.email ? this.validateEmail() ? "" : "Invalid mail" : ""), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(rmwc_TextField__WEBPACK_IMPORTED_MODULE_4__["TextField"], {
        box: true,
        required: true,
        className: "atomic-register-text-field atomic-text-field",
        style: {
        ...
        style: {
          alignSelf: "start",
          color: this.colorForPassword(),
          fontSize: "13px"
        }
      }, this.checkPassword()), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(rmwc_TextField__WEBPACK_IMPORTED_MODULE_4__["TextField"], {
        box: true,
        required: true,
        className: "atomic-register-text-field atomic-text-field",
        style: {
        ...
        style: {
          alignSelf: "start",
          color: this.state.password == this.state.passwordConfirm ? "#2196f3" : "#f44336",
          fontSize: "13px"
        }
      }, this.state.password && this.state.passwordConfirm ? this.state.password == this.state.passwordConfirm ? "Password match" : "Password doesn't match" : ""), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_recaptcha__WEBPACK_IMPORTED_MODULE_6___default.a, {
        className: "atomic-recaptcha",
        theme: "dark",
        sitekey: "6LdGeWkUAAAAAJaTLXmNHX8w_NHBUTXPjFJWLFCp"
      }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(rmwc_Button__WEBPACK_IMPORTED_MODULE_3__["Button"], {
        raised: true,
        accent: true,
        onSubmit: this.validateForm,
        theme: "secondary"
  ...
  return Register;
}(_components_base_page__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"]);
